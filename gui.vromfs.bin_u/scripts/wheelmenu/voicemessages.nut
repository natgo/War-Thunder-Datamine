...
let voiceMessageNames = [
  ...
  { category = "request", name = "voice_message_request_air_support", blinkTime = 6, haveTarget = false, showPlace = true, useTargetIfExist=true, icon = "icon_attacking", iconBlinkTime = 6},
